<?php
	class barang
	{
		...
		{
			return $this->biaya_penyimpanan;
		}
		function getPeriode_Permintaan ()
		{
			return $this->periode_permintaan;
		}
		function getSatuan ()
		{
			return $this->satuan;
		...
		function AddBarang ()
		{
			$sqlAddBarang = mysqli_query ($this->conn, "INSERT INTO barang VALUES ('$this->id_barang','$this->nama_barang','$this->harga_barang','$this->biaya_penyimpanan', '$this->periode_permintaan','$this->satuan','$this->konversi')");
		}
		function BarangList ()
		{
			$sqlBarangList = mysqli_query ($this->conn, "SELECT * FROM barang ORDER BY nama_barang ASC");
		...
		{
			$sqlEditBarang = mysqli_query ($this->conn, "SELECT * FROM barang WHERE id_barang = '$id'");
		...
		{
			$sqlBarangUpdate = mysqli_query ($this->conn, "UPDATE barang SET nama_barang = '$this->nama_barang', harga_barang = '$this->harga_barang', biaya_penyimpanan = '$this->biaya_penyimpanan', periode_permintaan = '$this->periode_permintaan', satuan ='$this->satuan', konversi = '$this->konversi' WHERE id_barang = '$this->id_barang'");
		...
		{
			$sqlBarangDelete = mysqli_query ($this->conn, "DELETE FROM barang WHERE id_barang = '$id'");
		}
		function StokBarang ()
		{
			$sqlStokBarang = mysqli_query ($this->conn, "SELECT
						barang.nama_barang,	
...
/*		function BE ()
		{
			$sqlBE = mysqli_query ($this->conn, "SELECT
					barang.nama_barang,
...
*/		
		function EOQ ()
		{
			$sqlEOQ = mysqli_query ($this->conn, "SELECT
							barang.nama_barang,
							barang.harga_barang,
							barang.konversi,
		...
		function ROP ()
		{
			$sqlROP = mysqli_query ($this->conn, "SELECT
						barang.nama_barang,
						barang.harga_barang,
						barang.satuan,
						barang.konversi,
